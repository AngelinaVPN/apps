...
Java_ru_angelinavpn_core_Core_startTun(JNIEnv *env, jobject, const jint fd, jobject cb) {
...
extern "C"
JNIEXPORT void JNICALL
Java_ru_angelinavpn_core_Core_stopTun(JNIEnv *, jobject) {
    stopTun();
}
...
JNI_OnLoad(JavaVM *vm, void *) {
    ...
    const auto c_tun_interface = find_class("ru/angelinavpn/core/TunInterface");
